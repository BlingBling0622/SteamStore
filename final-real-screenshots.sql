...
UPDATE products SET
  ...
  about_the_game = 'Winner of over 175 Game of the Year Awards, RDR2 is the epic tale of outlaw Arthur Morgan and the infamous Van der Linde gang on the run across America.'
WHERE id = 3;

SELECT id, name, 'Real Steam Screenshots Added!' as status FROM products WHERE id IN (1,2,3);
